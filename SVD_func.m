function varargout = SVD_func(A,varargin)
%--------------------------------------------------------------------------
% Syntax:       [U S V] = SVD_func(A);
%               [U S V] = SVD_func(A,'full');
%               [U S V] = SVD_func(A,'compact');
%               s = SVD_func(A);
%               s = SVD_func(A,'full');
%               s = SVD_func(A,'compact');
%
% Inputs:       A is an arbitrary M x N real-valued matrix
...
%--------------------------------------------------------------------------
  ...
  if strcmpi(mode,'compact')
    ...
    SVD_TOL = max(m,n) * max(svals) * eps(class(A));
